...
namespace PartyIcons.View
{
    ...
    {
        private Dictionary<string, int[]> _icons      = new();
        private Dictionary<string, float> _iconScales = new();
        ...
        public IconSet()
        {
            ...
            Add("Blue", new[]
            {
                ...
                94125, 94123, 94124, 94127, 94128, 94129, 94130, 94131, 94131, 94132,
            }, 2);
            Add("Green", new[]
            {
        ...
        public void Add(string id, int[] icons, float scale = 1f)
        {
            _icons[id] = icons;
            _iconScales[id] = scale;
        }

        public int GetJobIcon(string set, uint jobId)
        {
            return _icons[set][jobId - 1];
        }
    }
}